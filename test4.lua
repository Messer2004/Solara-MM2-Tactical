...
RS.RenderStepped:Connect(function()
    ...
    if Plr.Character and Plr.Character:FindFirstChild("HumanoidRootPart") then
        ...
        local rArm = tor and (tor:FindFirstChild("Right Shoulder") or Plr.Character:FindFirstChild("RightUpperArm"):FindFirstChild("RightShoulder"))
        local lArm = tor and (tor:FindFirstChild("Left Shoulder") or Plr.Character:FindFirstChild("LeftUpperArm"):FindFirstChild("LeftShoulder"))
        ...
        if not (State.Sharpening or State.Salute or State.CombinedSalute) then
            if rArm and rArm:IsA("Motor6D") and rArm.C0 ~= CFrame.new(1, 0.5, 0) then rArm.C0 = CFrame.new(1, 0.5, 0) end
            if lArm and lArm:IsA("Motor6D") and lArm.C0 ~= CFrame.new(-1, 0.5, 0) then lArm.C0 = CFrame.new(-1, 0.5, 0) end
        else
