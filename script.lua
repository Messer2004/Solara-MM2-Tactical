...
Tele:CreateButton({Name = "PickUp Gun", Callback = function() local g = workspace:FindFirstChild("GunDrop") or workspace:FindFirstChild("Gun") or (workspace:FindFirstChild("Normal") and workspace.Normal:FindFirstChild("GunDrop")) if g and Plr.Character and Plr.Character:FindFirstChild("HumanoidRootPart") then local h = Plr.Character.HumanoidRootPart local s = h.CFrame h.CFrame = g.CFrame task.wait(0.2) h.CFrame = s end end})
