...
Tab:CreateKeybind({
   ...
   Callback = function(State)
       ...
       if hum then hum.WalkSpeed = State and walkSpeedSprint or walkSpeedNormal end
   end,
})
...
Tab:CreateSlider({
    ...
    Callback = function(Value)
        ...
        local hum = LocalPlayer.Character and LocalPlayer.Character:FindFirstChildOfClass("Humanoid")
        if hum and not UserInputService:IsKeyDown(Enum.KeyCode.Z) then hum.WalkSpeed = Value end
    end,
})
